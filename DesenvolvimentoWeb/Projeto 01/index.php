			...
			<div class="row thumbnails owl-carousel owl-theme">
				<div class="item">
					<div class="item-inner">
						...
						<h3>Orlando City Acquires Goalkepper Joe Bendik from Toronto FC</h3>
		...
		<div id="call-to-action">
			<div class="container">
				...
				<div class="row">
					...
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Atque ipsam facilis quo at aspernatur vero deserunt quisquam natus blanditiis optio, modi itaque est nostrum dolore enim velit quam explicabo incidunt. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eum, reprehenderit! Provident quasi ipsam totam!.</p>
	...
	<footer>
						...
						<div class="row row-cols">
							...
							<div class="col-md-4 col-get-in-touch">
								...
								<address class="hidden-xs">
									<i class="fas fa-map-marker-alt"></i><span>618 E. South Street, Suite 510<br/>Orlando, FL 32801</span>
								</address>

								<p class="hidden-xs"><a href="tel:1855ORLANDOCITY"><i class="fas fa-phone"></i>1.855.ORL.CITY</a></p>
		...
		<div class="row row-cinza-escuro">
			...
			<div class="container copyright-mobile">
				...
				<p class="pull-left">Copyright © Orlando City Soccer 2020. All rights reserved.</p>
				<p class="pull-right text-roxo">Created by Wesley Rodrigues dos Santos in my computer</p>
